    ...
    return (
        ...
        <header className="App-header">
            ...
            */}
            ...
            <p id="homepageHeaderMessage">Personalized care that you <i style={{"fontSize": "4.3rem"}}><u>enjoy</u></i></p>
    ...
    return (
        ...
        <div className="container">
            ...
            <div className="columns">
                ...
                <HomePageOption linkDestination={"./property-management"} picSource={Property} linkName={<p className="altFont">Property Management</p>} />
